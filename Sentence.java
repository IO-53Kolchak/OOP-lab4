...
public class Sentence {
    ...
    public Sentence(String s) {
        // Регулярка розбиває текст, зберігаючи знаки пунктуації як окремі елементи
        ...
        for (String part : parts) {
            ...
            if (part.matches("[,.!?]")) {
                temp.add(new Punctuation(part.charAt(0))); // Якщо знак — створюємо Punctuation
            } else {
                temp.add(new Word(part)); // Якщо слово — створюємо Word
            }
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < elements.length; i++) {
            ...
            // Ставимо пробіл між двома словами, щоб текст не злипався
