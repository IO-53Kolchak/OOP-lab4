...
class FurnitureTest {
    ...
    void testTextFormatting() {
        String input = "Меблі   з   \t табуляцією. Речення  з    пробілом."; // Тут крапка є
        Text text = new Text(input);

        // Додаємо крапку в кінці очікуваного рядка
        String expected = "Меблі з табуляцією. Речення з пробілом.";

        assertEquals(expected, text.toString(), "Текст має бути відформатований правильно");
    }
